...
///         Bytecode (79 bytes):
///
///           ┌─ ecrecover input setup (27 bytes) ──────────────────┐
...
///           │  15 60 45 57             fail if !success           │
///           └─────────────────────────────────────────────────────┘
///           ┌─ build ownerId + return (24 bytes) ─────────────────┐
///           │  60 80 51                load recovered address     │
///           │  80 15 60 45 57          fail if address(0)         │
...
library K1Sandbox {
    ...
    function bytecode() internal pure returns (bytes memory) {
        return
            ...
            hex"6004355F52" // hash → mem[0x00]  (CALLDATALOAD 0x04)
